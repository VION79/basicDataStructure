...
function filteredArray(arr, elem) {
    ...
    // Only change code below this line
    for (let i = 0; i<arr.length; i++) {
      if (arr[i].indexOf(elem) == -1) { //This Checks every parameter for the elemment and if is NOT there continues the code
        newArr.push(arr[i]); //Inserts the element that passed above filter
